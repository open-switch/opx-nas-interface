...
cps_api_return_code_t nas_fill_all_bridge_info(cps_api_object_list_t *list, model_type_t model)
{
    // TODO check if List pointer is required to be passed
    std::for_each(bridge_map.bmap.begin(), bridge_map.bmap.end(), [list, model] (pair_t const& br_obj) {
