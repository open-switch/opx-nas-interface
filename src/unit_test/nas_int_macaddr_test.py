...
def check_mac_addr_get(if_type, fp_port = None, vlan_id = None, lag_id = None):
    ...
    if if_type == 'front-panel':
        ...
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'fp_port'), fp_port)
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'intf_type'),
        ...
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'vlan_id'), vlan_id)
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'intf_type'),
                         'ianaift:l2vlan')
    elif if_type == 'lag':
        if lag_id is None:
        ...
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'if_name'), lag_name)
        cps_obj.add_attr(nas_comm.get_value(nas_comm.attr_name, 'intf_type'),
