...
//t_std_error nas_create_bridge(const char *name, hal_vlan_id_t vlan_id, hal_ifindex_t idx, NAS_BRIDGE **bridge_obj);
//t_std_error nas_create_bridge(const char *br_name, hal_vlan_id_t vlan_id, NAS_BRIDGE **bridge_obj = nullptr)
t_std_error nas_bridge_create_vlan(const char *br_name, hal_vlan_id_t vlan_id, hal_ifindex_t *idx,
