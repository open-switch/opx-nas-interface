...
def config_intf(args):
    ...
    if args.operation == 'create':
        ...
        fp_port_id = l[1]
        subport_id = l[2]
        call(["cps_set_oid.py", "target", "rpc", set_intf_key, oper_key + '=' + oper_type[args.operation], intf_type_key+'='+intf_types[args.type], intf_name_key+'='+ args.intf_name, fp_port_key+'='+fp_port_id, subport_id_key+'='+subport_id])
    elif args.operation == 'delete':
        call(['cps_set_oid.py', 'target', 'rpc', set_intf_key, oper_key + '=' + oper_type[args.operation], intf_name_key+'='+ args.intf_name])
    else:
        call(['cps_set_oid.py', 'target', 'rpc', set_intf_key, oper_key + '=' + oper_type[args.operation], intf_name_key+'='+ args.intf_name,
                                                                                                           args.Key+'='+args.Value])
...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--type", choices=intf_types, default=intf_types['ether'], help=" Interface type ")
